...
from excepcion import ValorEdatIncorrecteException, ValorEdadErrorDato
...
class persona:
    ...
    def __init__(self, c_dni = "", c_nom = "", c_edat = 0,c_dataNaix = data()):
        ...
        if(isinstance(c_edat,int)):
            raise ValorEdadErrorDato(c_edat)

        elif(c_edat < 0 or c_edat > 130):
