                    ...
                    function valida(){
                        ...
                        function procesa(){
                            ...
                            if ((atr1 == '') || (atr2 == '') ||(atr3 == '')){
                                        ...
                                        var direccio='http://127.0.0.1/examen/pruebas.php?tireqty='+atr1+'&oilqty='+atr2+'&sparkqty='+atr3+'&find='+fnd;
...
?>
            ...
            while(!feof($fp))
           {
               ...
               if (($lineaLeida[0]!="") || ($lineaLeida[1]!="")|| ($lineaLeida[2]!="")|| ($lineaLeida[3]!="")|| ($lineaLeida[4]!=""))
               {
                   ...
                   echo '<td><input type="button" value="descompte" id="descuento"/></td>';
                   echo '</tr>';
               }
